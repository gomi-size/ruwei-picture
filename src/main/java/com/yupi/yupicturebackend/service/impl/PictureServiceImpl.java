    ...
    **/
    ...
    public Page<PictureVO> getPictureVOPage(PictureQueryRequest pictureQueryRequest, HttpServletRequest request) {
        ...
        //如果是私人图库那就管理员和创建人都能查看
            ...
            //1.3团队用户空间，管理员或者本空间的成员可以看
            boolean hasPermission = StpKit.SPACE.hasPermission(SpaceUserPermissionConstant.PICTURE_VIEW);
            boolean hasAdmin = loginUser.getUserRole().equals(UserRoleEnum.ADMIN.getValue());
            ThrowUtils.throwIf(!hasPermission&&!hasAdmin, ErrorCode.NO_AUTH_ERROR,"不是管理员或者本空间成员不能查看");
        }
        //2.使用缓存
